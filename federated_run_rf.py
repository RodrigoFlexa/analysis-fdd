...
parser.add_argument('--rounds', type=int, default=97)
parser.add_argument('--batch', type=int, default=32)
parser.add_argument('--epoch', type=int, default=10)
parser.add_argument('--strategy', type=str, default='avg')
parser.add_argument('--nn', type=str, default='inception')
...
def start_server():
    if args.strategy == 'avg':
        ...
        model = network.build_model(input_shape=(40,3), nb_classes=NUM_CLIENTS)
...
def run_simulation(train_dataframe, test_dataframe):
    ...
    for i in range(len(train_list_user)):
    	...
    	client_process = Process(target=create_client, args=(i, train_dataframe_user[i], test_dataframe))
